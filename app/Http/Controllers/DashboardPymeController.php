...
class DashboardPymeController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        if ($request->fecha_inicio && $request->fecha_fin) {
            ...
            ->whereBetween('v.created_at',[carbon::parse($request->fecha_inicio)->format('Y-m-d'),carbon::parse($request->fecha_fin)->format('Y-m-d')])            ->groupBy(DB::raw('MONTH(v.fecha_hora)'), DB::raw('YEAR(v.fecha_hora)'))
