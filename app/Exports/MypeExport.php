...
class MypeExport implements FromView, WithStyles, WithDrawings, WithColumnWidths, WithCustomStartCell, WithTitle
{
    /**
    ...
    */
    public function view(): View
    {
        ...
        return view('Excell.PorMype.exportproducto', compact('productos'));
    }
