    ...
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col-lg-9">
                ...
                <p class="text-muted">Se muestran la lista de empresas asociadas</p>
            </div>
             <div class="col-lg-3 d-flex">
                <a href="{{ url('/empresa_asesor/create') }}" class="btn btn-primary w-100 align-self-center text-white"><i class="bi bi-plus-circle-fill me-2"></i> Nueva Empresa</a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6  col-sm-12 mb-2">
                <div class="btn-group float-md-end  border rounded shadow-sm" role="group" aria-label="Basic example">
                    <a href="{{ url('/excel/asesores-Empresa') }}" target="blank"><button type="button" class="btn btn-light">EXCEL</button></a>
                    <a href="{{ url('AsesorpdfEmpresa') }}" target="blank"><button type="button" class="btn btn-light">PDF</button></a>
