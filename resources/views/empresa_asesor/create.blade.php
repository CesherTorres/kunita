...
<section class="py-3">
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col-lg-9">
                <h3 class="text-success fw-bold mb-0"> Nueva Empresa</h3>
                <p class="lead text-muted">Llena los campos para registrar una nueva empresa con tu asesoría</p>
            </div>
        ...
        @endif
        <form method="post" name="new_purchase" id="new_purchase" action="/empresa_asesor" enctype="multipart/form-data">
            @csrf
            <div class="row">
