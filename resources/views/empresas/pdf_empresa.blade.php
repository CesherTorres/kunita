        ...
        <table class="w-100" style="font-size: 10px; ">
            <thead>
                <tr>
                    ...
                    <th class="border" style="width: 10%">IDENTIFICACIÓN</th>
                    <th class="border" style="width: 10%">GIRO</th>
                    <th class="border" style="width: 20%">CORREO EMP.</th>
                    <th class="border" style="width: 10%">TELEFONO</th>
                    <th class="border" style="width: 20%">ASESOR</th>
                </tr>
            </thead>
            <tbody class="alto">
                @foreach ($companys as $company)
                    <tr> 
                        ...
                        <td class=" align-top text-blue border-start border-bottom border-end" style="width: 10%">{{$company->user->name}}</td>
