...
<section class="py-3">
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col-lg-9">
                <h3 class="text-success fw-bold mb-0"> Actualizar Empresa</h3>
                <p class="lead text-muted">Manten actualizados los datos de las empresas</p>
            </div>
        ...
        <form method="post" name="new_purchase" id="new_purchase" action="/empresas/{{$user->id}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                            ...
                            <div class="card-body">           
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12 mb-1">               
                                        ...
                                        <input type="text" name="name" id="name" value="{{$user->name}}" class="form-control form-control-sm">            
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-1">               
                                    ...
                                    <select class="form-select form-select-sm " name="tipodocumento" id="tipodocumento">
                                        <option value="{{$user->tipodocumento}}" hidden="hidden" selected="selected"> {{$user->tipodocumento}} </option>
                                ...
                                <div class="form-group mb-1">               
                                    ...
                                    <input type="text" name="ndocumento" value="{{$user->ndocumento}}" id="ndocumento" class="form-control form-control-sm"> 
                                </div>
                                
                                <div class="form-group mb-1">               
                                    <label for="telefono" class="form-label">Telefono(*)</label>
                                    <input type="text" name="telefono" id="telefono" value="{{$user->telefono}}" class="form-control form-control-sm"> 
                                </div>

                                <div class="form-group mb-1">               
                                    <label for="email" class="form-label">Email(*)</label>
                                    <input type="email" name="email" id="email" value="{{$user->email}}" class="form-control form-control-sm">           
                                </div>

                                {{-- <div class="form-group mb-1">               
                                    <label for="password" class="form-label">Contraseña(*)</label>
                                    <input type="password" name="password" value="{{$user->password}}" id="password" class="form-control form-control-sm"  required> 
                                </div>
                                
                                <div class="form-group mb-1">               
                                    <label for="confirmpassword" class="form-label">Confirmar Contraseña(*)</label>
                                    <input type="password" name="confirmpassword" value="{{$user->confirmpassword}}" id="confirmpassword" class="form-control form-control-sm"  required>           
                                </div> --}}
                                <div class="form-group mb-1">   
                            ...
                            <div class="card-body">           
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        ...
                                        <input type="text" name="razonsocial" id="razonsocial" value="{{$user->propietario->empresas->razonsocial}}" class="form-control form-control-sm"  required>            
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        <label for="ruc" class="form-label">Nro. RUC(*)</label>
                                        <input type="text" name="ruc" id="ruc" value="{{$user->propietario->empresas->ruc}}" class="form-control form-control-sm"  required> 
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        ...
                                        <input type="email" name="correoempresa" value="{{$user->propietario->empresas->correoempresa}}" id="correoempresa" class="form-control form-control-sm"  required>            
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        <label for="telefonoempresa" class="form-label">Telefono Empresa(*)</label>
                                        <input type="text" name="telefonoempresa" value="{{$user->propietario->empresas->telefonoempresa}}" id="telefonoempresa" class="form-control form-control-sm"  required> 
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        ...
                                        <input type="text" name="direccion" id="direccion" value="{{$user->propietario->empresas->direccion}}" class="form-control form-control-sm"  required> 
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        <label for="marca" class="form-label">Marca(*)</label>
                                        <input type="text" name="marca" id="marca" value="{{$user->propietario->empresas->marca}}" class="form-control form-control-sm"  required>           
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12 mb-1">   
                                        ...
                                        <select class="form-select form-select-sm js-example-basic-single" name="usuario_id" id="usuario_id">
                                            <option value="{{$user->propietario->empresas->user->id}}" disabled="disabled" selected="selected" hidden="hidden">{{$user->propietario->empresas->user->name}}</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                        ...
                                        <textarea class="form-control" name="descripcion" value="{{$user->propietario->empresas->descripcion}}" id="descripcion" rows="3">{{$user->propietario->empresas->descripcion}}</textarea>           
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12 mb-1">               
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12 mb-1">               
                                        ...
                                        <input type="text" name="ncuentabanco" id="ncuentabanco" value="{{$user->propietario->empresas->ncuentabanco}}" class="form-control form-control-sm" > 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-12 mb-1">               
                                        <label for="ncuentabancocci" class="form-label">Nro de CCI</label>
                                        <input type="text" name="ncuentabancocci" id="ncuentabancocci" value="{{$user->propietario->empresas->ncuentabancocci}}" class="form-control form-control-sm" > 
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12 mb-1">               
                                        ...
                                        <input type="text" name="numerobilletera" id="numerobilletera" value="{{$user->propietario->empresas->numerobilletera}}" class="form-control form-control-sm" > 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-12 mb-1">               
                                        ...
                                        <input type="text" name="enlacefacebook" id="enlacefacebook" value="{{$user->propietario->empresas->enlacefacebook}}" class="form-control form-control-sm"  required> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-12 mb-1">               
                                        <label for="enlacewhatsapp" class="form-label">Url WhatsApp(*) <i class="fab fa-whatsapp" style="color:green"></i></label>
                                        <input type="text" name="enlacewhatsapp" id="enlacewhatsapp" value="{{$user->propietario->empresas->enlacewhatsapp}}" class="form-control form-control-sm"  required> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-12 mb-1">               
                                        <label for="enlaceinstagram" class="form-label">Url Instagram(*) <i class="fab fa-instagram" style="color:#F04E52"></i></label>
                                        <input type="text" name="enlaceinstagram" id="enlaceinstagram" value="{{$user->propietario->empresas->enlaceinstagram}}" class="form-control form-control-sm"  required> 
                                    </div>
                                </div>
