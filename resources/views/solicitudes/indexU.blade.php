    ...
    <div class="offcanvas-body">
        ...
        <div class="menu">
            ...
            <a class="btn btn-secondary rounded-pill text-start text-white d-block mx-2 mt-2"><i class="bi bi-arrow-down-square me-2 lead"></i> Solicitudes</a>
                <a href="{{ url('/solicitudes') }}" class="text-white d-block p-3 mx-4"><i class="bi bi-arrow-down-square me-2"></i> Producto</a>
                <a href="{{ url('/solicitudesU') }}" class="text-secondary d-block  fw-bold px-3 py-1 mx-4"><i class="bi bi-arrow-down-square me-2"></i> Usuario</a>
    	                ...
    	                <tr>
                            ...
                            <td>                                        
                                <div class="text-center">
                                    <a href="/showUs/{{ $user->id }}" class="btn btn-outline-info btn-sm"><i class="bi bi-eye"></i> Detalles</a>
                                </div>      
                            </td>
                        </tr>
                        @endforeach
