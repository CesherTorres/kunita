...
<head>
    ...
    <title>Kunaq | Reporte de Categorías PDF</title>
...
<body>
    ...
    <div class="text-center mt-2">
        ...
        <span class="text-uppercase py-2 text-center text-primary small fw-bold d-block">Reporte Total de Categorías y subcategorías</span>
        
        <table class="w-100" style="font-size: 10px; ">
            <thead>
                <tr>
                    <th class="border" style="width: 30%">CATEGORÍA</th>
                    <th class="border" style="width: 30%">SUBCATEGORÍA</th>
            ...
            <tbody class="alto">
                @foreach ($subcategoria as $subcategorias)
                    <tr> 
                        <td class=" align-top text-blue border-start border-bottom" style="width: 30%">{{$subcategorias->categoria->namecategoria}}</td>
                        <td class=" align-top text-blue border-start border-bottom" style="width: 30%">{{$subcategorias->namesubcategoria}}</td>
                        <td class=" align-top text-blue border-start border-bottom border-end" style="width: 40%">{{$subcategorias->categoria->descripcion}}</td>
                    </tr>
