    ...
    <div class="offcanvas-body">
        ...
        <div class="menu">
            ...
            <a class="btn btn-secondary rounded-pill text-start text-white d-block mx-2 mt-2"><i class="bi bi-arrow-down-square me-2 lead"></i> Solicitudes</a>
                <a href="{{ url('/solicitudesproductos_asesor') }}" class="text-secondary d-block fw-bold p-3 mx-4"><i class="bi bi-arrow-down-square me-2"></i> Producto</a>
                <a href="{{ url('/solicitudesusuarios_asesor') }}" class="text-white d-block px-3 py-1 mx-4"><i class="bi bi-arrow-down-square me-2"></i> Usuario</a>
        </div>
    </div>
</div>
@endsection
...
<section class="py-3">
    <div class="container-fluid pt-3">
        ...
        <br>
        <form method="post" name="new_purchase" id="new_purchase" action="/solicitudesproductos_asesor/{{$producto->id}}">
        @csrf
        @method('put')
            ...
            <div class="form-group text-center">
                <a class="btn btn-outline-secondary btn-lg" href="{{ url('/solicitudesproductos_asesor') }}" role="button">Cancelar</a>
