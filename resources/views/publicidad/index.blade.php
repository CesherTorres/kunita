...
<section class="py-3">
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col-lg-9">
                <h1 class="text-success fw-bold mb-0"><i class="bi bi-newspaper me-2"></i> Publicidad</h1>
                <p class="lead text-muted">Lista de publicidad registradas</p>
            </div>
            <div class="col-lg-3 d-flex">
                ...
                <!-- <div class="btn-group w-100 align-self-center btn-sm pt-0" data-toggle="buttons">
                    ...
                    <label class="btn btn-outline-secondary" for="danger-outlined"><a href="{{ url('/listaPu') }}"><i class="bi bi-image"></i></a></label>
                </div> -->
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                        <a href="{{ url('/publicidad/create') }}" class="btn btn-warning text-white"> Nueva Publicidad</a>
                    </div>
