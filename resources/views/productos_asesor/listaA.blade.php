            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center" align="center">
                    ...
                    <div class="col col-sm col-md-6 col-lg-4">
                        <div id="cards">
                            <div class="image">
                            <img src="/images_product/{{$productos->imgprincipal}}" style="min-width: auto; min-height: 300px;"/>
                            </div>
                            <div class="details">
                                <div class="center">
                                    ...
                                    <form method="POST" action="{{ route('productos_asesor.destroy',$productos->id) }}" class="form-delete">
                                        ...
                                        <li><button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#aoferta{{$productos->id}}"><i class="bi bi-percent"></i></button></li>
                                    </form>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="aoferta{{$productos->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="/productos_asesor/aoferta/{{$productos->id}}" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf                                                  
                                        <div class="row">
                                            <div class="col-lg-6">
