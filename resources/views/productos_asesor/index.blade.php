                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6  col-sm-12">
                        <div class="btn-group float-md-end  border rounded shadow-sm" role="group" aria-label="Basic example">
                            <a href="{{ url('/excel/producto-exportA') }}"><button type="button" class="btn btn-light">EXCEL</button></a>
                            <a href="{{ url('productospdfA') }}"><button type="button" class="btn btn-light">PDF</button></a>
