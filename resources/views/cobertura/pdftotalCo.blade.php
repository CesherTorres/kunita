...
<head>
    ...
    <title>Kunaq | Reporte Coberturas PDF</title>
...
<body>
    ...
    <div class="text-center">
        ...
        <span class="text-uppercase pt-2 text-start text-primary small fw-bold d-block">Reporte Total de coberturas</span>
        <br>
        <table class="w-100" style="font-size: 10px; ">
            <thead>
                <tr>
                    <th class="border" style="width: 40%">DEPARTAMENTO/PROVINCIA/DISTRITO</th>
                    <th class="border" style="width: 30%">COSTO DE ENVÍO</th>
                    <th class="border" style="width: 30%">DIAS ESTIMADOS</th>
                </tr>
            </thead>
            <tbody class="alto">
                @foreach ($coberturas as $cobertura)
                    <tr> 
                        <td class=" align-top text-blue border-start border-bottom" style="width: 40%">{{$cobertura->ubigeos->departamento.'/'.$cobertura->ubigeos->provincia.'/'.$cobertura->ubigeos->distrito}}</td>
                        <td class=" align-top text-blue border-start border-bottom" style="width: 30%">S/ {{$cobertura->precioenvio}}</td>
                        <td class=" align-top text-blue border-start border-bottom border-end" style="width: 30%">{{$cobertura->diasestimados}} Días</td>
