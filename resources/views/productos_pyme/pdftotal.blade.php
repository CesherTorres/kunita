...
<body>
    ...
    <div class="text-center">
        ...
        <span class="text-uppercase pt-2 text-start text-primary small fw-bold d-block">Reporte Total de productos</span>
        <br>
            ...
            <tbody class="alto">
                @foreach ($productos as $producto)
                    <tr> 
                        ...
                        <td class=" align-top text-blue border-start border-bottom border-end" style="width: 20%">{{$producto->fecha_vencimiento}}</td>
                    </tr>
