        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6  col-sm-12 mb-2">
                <div class="btn-group float-md-end  border rounded shadow-sm" role="group" aria-label="Basic example">
                    <a href="{{ url('/excel/asesores-export') }}" target="blank"><button type="button" class="btn btn-light">EXCEL</button></a>
                    <a href="{{ url('/Asesorpdf') }}" target="blank"><button type="button" class="btn btn-light">PDF</button></a>
