...
<table id="tcompany" class="table table-hover table-sm" cellspacing="0" style="width:100%">
    <thead>
        <tr>
            <th colspan="17" style="background-color:#0069AA; color:white; "></th>
        </tr>
        <tr>
        ...
        <tbody>
            ...
            @foreach($productos as $producto)
                @php 
                    $productoss = \App\Models\Producto::find($producto->id);
                @endphp
                <tr>
                    <td class="font-weight-light" style="text-align: center; border:2px;">{{$contador}}</td>
                    <td class="font-weight-light" style="text-align: center; border:2px;">{{$productoss->empresa->razonsocial}}</td>
