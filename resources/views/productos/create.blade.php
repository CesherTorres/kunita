                    ...
                    <div class="card-body">           
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-sm-12 mb-1">               
                                ...
                                <input type="text" name="nameproducto" id="nameproducto" class="form-control form-control-sm"  required maxLength="60">            
                            </div>
                            <div class="form-group col-md-6 col-sm-12 mb-1">               
                                <label for="modelo" class="form-label">Modelo</label>
                                <input type="text" name="modelo" id="modelo" class="form-control form-control-sm" required maxLength="40"> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 col-sm-12 mb-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-lg-6 col-sm-12 mb-1">  
                                            <div class="form-group col-md-12 col-sm-12 mb-1">               
                                                ...
                                                <input type="text" name="stock" id="stock" class="form-control form-control-sm"  required onkeypress="return solonumerospunto(event)" onpaste="return false" maxLength="4">            
                                            </div>
                                        </div>
                                    </div>        
                            </div>
