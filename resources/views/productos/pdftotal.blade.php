...
<br>
<br>
    <u> <h1 class="text fw-bold mb-0 text-center py-1 display-1">Productos</h1></u>
                    ...
                    <table id="tcompany" class="table table-bordered" cellspacing="0" style="width:100%">
                        <thead class="table-dark">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td class="alert alert-primary">{{$producto->empresa->razonsocial}}</td>
                        ...
                        <thead class="table-dark">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td class="alert alert-primary">{{$producto->subcategoria->categoria->namecategoria.'/'.$producto->subcategoria->namesubcategoria}}</td>
