            ...
            <tbody class="alto">
                @foreach ($productos as $producto)
                    <tr> 
                        ...
                        <td class=" align-top text-blue border-start border-bottom" style="width: 20%">{{$producto->subcategoria->categoria->namecategoria.'/'.$producto->subcategoria->namesubcategoria}}</td>
                        ...
                        <td class=" align-top text-blue border-start border-bottom border-end" style="width: 20%">{{$producto->empresa->razonsocial}}</td>
                    </tr>
