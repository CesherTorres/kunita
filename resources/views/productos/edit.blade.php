...
<section class="py-3">
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col-lg-9">
                <h3 class="text-success fw-bold mb-0"><i class="bi bi-shop me-2"></i> Actualizar Producto</h3>
                <p class="lead text-muted">Actualiza los campos del producto</p>
            </div>
        ...
        <form method="post" name="new_purchase" id="new_purchase" action="/productos/{{$producto->id}}" enctype="multipart/form-data">
        @csrf
        @method('put')
                    ...
                    <div class="card-body">           
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-sm-12 mb-1">               
                                ...
                                <input type="text" name="nameproducto" id="nameproducto" value="{{$producto->nameproducto}}" class="form-control form-control-sm"  required onkeypress="return sololetrasespace(event)" onpaste="return false" maxLength="60">            
                            </div>
                            <div class="form-group col-md-6 col-sm-12 mb-1">               
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-sm-12  my-2 my-md-0 order-2 order-md-1">
                                ...
                                <textarea class="form-control " placeholder="Leave a comment here" placeholder="Max. 190 caracteres" id="descripcion" name="descripcion" rows="5" maxlength="190">{{$producto->descripcion}}</textarea>
                            </div>
