            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                    <div class="card border-primary shadow-sm mb-3 text-center h-100">
                        <div class="card-body">
                            <h6 class="card-title text-dark ">Solicitudes Usuario Empresa</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                    <div class="card border-secondary shadow-sm mb-3 text-center h-100">
                        <div class="card-body">
                            <h6 class="card-title text-dark ">Total Usuarios Pyme</h6>
                            @foreach($empresas as $emp)
                                <h3 class="fw-bold text-primary">{{$emp->empresas}}</h3> 
                            @endforeach
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                    <div class="card border-danger shadow-sm mb-3 text-center h-100">
                        ...
                        <div class="card-footer bg-danger">
                            <a href="{{ url('/productos_asesor') }}" class="text-white text-decoration-none">Información</a>
                        </div>
                    </div>
                </div>
            </div>
