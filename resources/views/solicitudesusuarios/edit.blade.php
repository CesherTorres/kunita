    ...
    <div class="offcanvas-body">
        ...
        <div class="menu">
            ...
            <a class="btn btn-secondary rounded-pill text-start text-white d-block mx-2 mt-2"><i class="bi bi-arrow-down-square me-2 lead"></i> Solicitudes</a>
                <a href="{{ url('/solicitudesproductos') }}" class="text-white d-block p-3 mx-4"><i class="bi bi-arrow-down-square me-2"></i> Producto</a>
                <a href="{{ url('/solicitudesusuarios') }}" class="text-secondary d-block  fw-bold px-3 py-1 mx-4"><i class="bi bi-arrow-down-square me-2"></i> Usuario</a>
...
<section class="py-3">
    <div class="container-fluid pt-3">
            ...
            <div class="card-body">
               <div class="row">
                    <div class="col-md-3 col-sm-12 text-center">
                        <img width="280px" height="98px" src="/public/logos/{{$user->propietario->empresas->logoempresa}}" />
                    </div>
        ...
        <br>
        <form method="post" name="new_purchase" id="new_purchase" action="/solicitudesusuarios/{{$user->id}}">
        @csrf
        @method('put')
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div class="form-check form-check-inline lead">
                            <input class="form-check-input" type="radio" name="estadouser" id="inlineRadio2" value="Rechazado">
            ...
            <div class="form-group text-center">
                <a class="btn btn-outline-secondary btn-lg" href="{{ url('/solicitudesusuarios') }}" role="button">Cancelar</a>
